  ...
  return (
    <Link href="/" className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
      ...
      <div className="flex flex-col leading-none">
        <span
          className={`font-bold tracking-widest uppercase ${textSize}`} style={{ color: light ? '#D7F36A' : '#0D3D2E', fontFamily: 'Georgia, serif', letterSpacing: '0.12em' }}
        >
          Acreonix
        </span>
        <span
          className="text-[10px] tracking-[0.2em] uppercase" style={{ color: light ? 'rgba(255,255,255,0.5)' : '#c9a84c', fontFamily: 'Georgia, serif' }}
        >
          Tasks
        </span>
      </div>
